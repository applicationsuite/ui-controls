...
> **Adapter source isn't bundled.** Reference adapters for Fluent UI v9, MUI, and a CSS-only "material-like" look ship as copy-paste source under [`../examples/adapters/`](../examples/adapters/). See [Adapters.md](Adapters.md) for the contract and how to drop one into your app.
